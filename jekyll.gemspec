...
Gem::Specification.new do |s|
  ...
  s.files = [
    ".gitignore",
     ...
     "lib/jekyll/category_listing.rb",
  ...
  s.test_files = [
    "test/_site/helper.rb",
     "test/_site/suite.rb",
     "test/_site/test_archive.rb",
     "test/_site/test_configuration.rb",
     "test/_site/test_core_ext.rb",
     "test/_site/test_filters.rb",
     "test/_site/test_generated_site.rb",
     "test/_site/test_page.rb",
     "test/_site/test_pager.rb",
     "test/_site/test_post.rb",
     "test/_site/test_site.rb",
     "test/_site/test_tags.rb",
     "test/helper.rb",
     "test/suite.rb",
     "test/test_archive.rb",
     "test/test_configuration.rb",
